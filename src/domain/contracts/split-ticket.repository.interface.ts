...
export interface ISplitTicketRepository {
  ...
  create(ticket: Omit<SplitTicketEntity, 'id' | 'createdAt' | 'updatedAt' | 'lines'>): Promise<SplitTicketEntity>;
  update(id: number, ticket: Partial<SplitTicketEntity>): Promise<SplitTicketEntity>;
}
