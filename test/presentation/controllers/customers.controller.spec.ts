...
import { UpdateCustomerStatusUseCase } from "../../../src/application/use-cases/customers/update-customer-status.use-case";
import { CustomerStatus } from "../../../src/domain/enums";
